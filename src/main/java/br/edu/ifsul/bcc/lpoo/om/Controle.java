...
import br.edu.ifsul.bcc.lpoo.om.gui.maoobra.JPanelMaoObra;
...
public class Controle {
    ...
    private JPanelMaoObra telaMaoObra;
    ...
    public void initComponents(){
        ...
        telaMaoObra = new JPanelMaoObra(this);
        ...
        jframe.addTela(telaMaoObra, "tela_maoobra");
    ...
    public void showTela(String nomeTela) throws Exception{
        ...
        }else if(nomeTela.equals("tela_maoobra")){
             telaMaoObra.showTela("tela_maoobra_listagem");
         }
